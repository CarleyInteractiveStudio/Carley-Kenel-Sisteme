...
static video_framebuffer_t *framebuffer;
static video_framebuffer_t vbe_fb; // Estructura local para modo VBE
...
void video_init(video_framebuffer_t *fb) { framebuffer = fb; }
